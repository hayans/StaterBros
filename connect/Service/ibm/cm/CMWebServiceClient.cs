...
//using connect.Models.ibm.cm.items;
using System.IO;
using System.Xml;
...
namespace connect.Service.ibm.cm
{
    public class CMWebServiceClient
    {
        ...
        public static string getFolderUri(AuthenticationData authData, string query)
        {
            ...
            request.QueryCriteria.QueryString = "/HrEmpFolder[ @HREmployeeID = \\" + query + "\"]";
